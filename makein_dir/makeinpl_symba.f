...
c  temporal variables
      integer i,j
      double precision t00,y(6),yp(6),m0,n0,mass1,rhill,r
...
c the Sun is in the heliocentric frame
        if (i.eq.1) then
          read(*,*) mass
          read(*,*) elmts
...
c calculate Hill spheres radii
          if (rhill.lt.1.e-16) then
            call util_hills1(mass1,mass,y(1),y(2),y(3),y(4),y(5),y(6),
     :        rhill)
          endif
          write(*,fmt) mass, rhill, r
        endif
