...
set yl "{/Helvetica-Oblique e}_p" offset +1,0
...
p \
   "check_BOX.dat" u 36:37 w p pt 7 lt 9 ps 0.33,\
   "89_Julia_family.list_80" u 36:37 w p pt 7 lt 8 ps 0.33,\
   "check_BOX.dat" u 36:37:(f_($48)):(pV_pIR($50, $54)) w p pt 7 ps variable lc rgb variable,\
   sprintf("<awk '($36>%f) && ($36<%f) && ($37>%f) && ($37<%f) && ($38>%f) && ($38<%f)' ../families.syn", a1,a2,e1,e2,sinI1,sinI2) u 36:37:34 w labels center font "Helvetica,12",\
#pa -1
