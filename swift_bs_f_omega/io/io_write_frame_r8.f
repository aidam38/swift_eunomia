...
c                            IO_WRITE_FRAME_R8
c*************************************************************************
c write out a whole frame to an real*8 binary file.
...
c Date: May 2nd 1999
      ...
      subroutine io_write_frame_r8(time,nbod,ntp,mass,xh,yh,zh,vxh,
...
c...  if first time through open file
      ...
      call io_write_hdr_r8(iu,time,nbod,ntp,istat)
...
c...  write out planets
     ...
     &          ialpha,a,e,inc,capom,omega,capm)
         call io_write_line_r8(iu,id,a,e,inc,capom,omega,capm)
      enddo
...
c...  write out test particles
     ...
     &          vzht(i),gm,ialpha,a,e,inc,capom,omega,capm)
            call io_write_line_r8(iu,i,a,e,inc,capom,omega,capm)
         endif
      enddo
